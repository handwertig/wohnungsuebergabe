...
-- Beispiel-Daten für Version 1 bestehender Protokolle
INSERT IGNORE INTO protocol_versions (protocol_id, version_number, version_data, notes, created_at)
SELECT 
    id as protocol_id,
    1 as version_number,
    payload as version_data,
    'Initiale Version (Migration)' as notes,
    created_at
FROM protocols 
