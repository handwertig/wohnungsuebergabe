...
echo "🎨 Verbessere Protocols UI: Bündigkeit + Einheiten-Accordion"
echo "============================================================"

# Backup
cp backend/src/Controllers/ProtocolsController.php backend/src/Controllers/ProtocolsController.php.backup_ui_$(date +%Y%m%d_%H%M%S)

# Aktualisierte ProtocolsController.php mit verbesserter UI
...
echo "✅ ProtocolsController.php mit verbesserter UI aktualisiert"
...
if command -v php >/dev/null 2>&1; then
    ...
    if php -l backend/src/Controllers/ProtocolsController.php; then
        ...
        cp backend/src/Controllers/ProtocolsController.php.backup_ui_$(date +%Y%m%d_%H%M%S) backend/src/Controllers/ProtocolsController.php
        exit 1
    fi
else
...
echo ""
echo "🎉 PROTOCOLS UI VERBESSERT!"
echo "=========================="
echo "✅ Verbesserungen:"
echo "   1. 📐 Bündige Anzeige der Einheiten-Anzahl"
echo "   2. 🪗 Verschachtelte Accordions: Haus → Einheit → Protokolle"
echo "   3. 🎨 Verbesserte Optik:"
echo "      - Hellgraue Einheiten-Header (bg-light)"
echo "      - Bessere Button-Gruppierung"
echo "      - Hover-Effekte auf Tabellen"
echo "      - Kleinere Datum-Anzeige"
echo "      - Korrekte Singular/Plural-Formen"
echo ""
echo "🎯 Neue Struktur:"
echo "   📋 Filter-Formular"
echo "   └── 🏠 Hamburg, Musterstraße 1        [3 Einheiten]"
echo "       ├── 🪗 Einheit A                  [2 Protokolle] ⤵"
echo "       │   ├── 📄 Einzugsprotokoll"
echo "       │   └── 📄 Auszugsprotokoll"
echo "       ├── 🪗 Einheit B                  [1 Protokoll] ⤵"
echo "       │   └── 📄 Zwischenprotokoll"
echo "       └── 🪗 Einheit C                  [0 Protokolle] ⤵"
echo ""
echo "🧪 Testen Sie:"
echo "👉 http://127.0.0.1:8080/protocols"
echo "   - Klappen Sie Häuser auf/zu"
echo "   - Klappen Sie einzelne Einheiten auf/zu"
echo "   - Prüfen Sie die bündige Anzeige der Zahlen"